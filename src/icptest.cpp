...
main(int argc, char **argv) {
    ...
    //if(i == 0) {
    if (pcl::io::loadPCDFile("halfcube100filtered.pcd", *cloudIn) == -1) {
    ...
    if (pcl::io::loadPCDFile("cuberesult.pcd", *cloudOut) == -1) {
    ...
    icp.setMaxCorrespondenceDistance(90);
    ...
    pcl::io::savePCDFileASCII("cuberesult2.pcd", finalCloud);
    //}
